...
class Cannon(// view containing the Cannon
    ...
    private var barrelAngle: Double = 0.0// angle of the Cannon's barrel = 0.0
    ...
    fun fireCannonball() { // calculate the Cannonball velocity's x component
    ...
    fun draw(canvas: Canvas) { // draw cannon barrel
        canvas.drawLine(0f, view.screenHeight / 2.toFloat(), barrelEnd.x.toFloat(),
                barrelEnd.y.toFloat(), paint)
        // draw cannon base
        canvas.drawCircle(0f, view.screenHeight / 2.toFloat(),
...
private fun Canvas.drawCircle(fl: Float, fl1: Float, fl2: Float, unit: Unit, paint: Paint) {
