...
public class CalculateBMI extends Activity implements View.OnClickListener
{
    ...
    public void onClick(View arg0)
    {
        ...
        {
            if(bmi<10){ result.setText("Are you sure you enter properly weight and height? System says you must eat 10 cheeseburgers..");}
            else{result.setText(message + "underweight! Let's eat something");}
        }
